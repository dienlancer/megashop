...
<form class="form-horizontal" role="form">	
	<div class="portlet light bordered">
		...
		<div class="portlet-body">		
			<table class="table table-striped table-bordered table-hover table-checkable order-column" id="tbl-user">
				<thead>
					<tr>
...
<script type="text/javascript" language="javascript">	
	...
	function checkWithList(this_checkbox){
		var dr = vUserTable.row( $(this_checkbox).closest('tr') ).data();       		
		...
		vUserTable.row( $(this_checkbox).closest('tr') ).data(dr);
	}	
