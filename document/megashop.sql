...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 08, 2017 lúc 01:00 PM
...
CREATE DEFINER=`depnua`@`localhost` PROCEDURE `pro_getArticle` (IN `keyword` VARCHAR(255), IN `category_id` VARCHAR(255))  begin
SELECT
    0 AS is_checked
    ,n.id
    ,n.fullname
...
CREATE DEFINER=`depnua`@`localhost` PROCEDURE `pro_getProduct` (IN `keyword` VARCHAR(255), IN `category_id` VARCHAR(255))  begin
SELECT
    0 AS is_checked
    ,n.id
    ,n.code
...
(25, 'Banner chính 1', '', 'banner-chinh-1', 'slideshow-1.jpg', '', '<p>nguyễn kim điền</p>\n\n<p><img alt=\"\" src=\"/megashop/upload/robot-proejct-1.png\" style=\"height:332px; width:480px\" /></p>\n\n<p>nguyễn kim triết</p>', '', '', '', '', 1, 1, '2017-11-21 15:05:25', '2017-12-01 17:56:34'),
...
(107, 'Liên hệ', 'lien-he', 0, 11, 0, 5, 1, '2017-11-28 02:28:21', '2017-11-28 02:28:21'),
(108, 'Phòng khách', 'phong-khach', 106, 11, 1, 1, 1, '2017-11-28 02:29:07', '2017-11-28 02:29:07'),
(109, 'Phòng ngủ', 'phong-ngu', 106, 11, 1, 2, 1, '2017-11-28 02:29:20', '2017-11-28 02:29:20'),
(110, 'Sofa', 'sofa', 106, 11, 1, 3, 1, '2017-11-28 02:29:33', '2017-11-28 02:29:33'),
(111, 'Phòng bếp', 'phong-bep', 106, 11, 1, 4, 1, '2017-11-28 02:29:46', '2017-11-28 02:29:46'),
(112, 'Phòng trẻ em', 'phong-tre-em', 106, 11, 1, 5, 1, '2017-11-28 02:30:03', '2017-11-28 02:30:03');
...
(11, 'MenuScroll', 'menu-scroll', 1, 11, '2017-11-28 02:23:55', '2017-11-28 02:25:43');
...
(11, 'Slideshow', '[{\"id\":25,\"sort_order\":\"1\"}]', 'slideshow', 'article', 1, 3, '2017-11-21 15:07:49', '2017-11-28 08:12:33'),
